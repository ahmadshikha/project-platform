...
<div class="container" style="direction: rtl">
    <div class="frame" style="height: auto">
        <div class="nav d-flex justify-content-center">
            <ul class="links ">
                <li class="signin-active "><a class="btn fs-3">تعديل أسئلة بداية الدورة</a></li>
            </ul>
        </div>
        <div ng-app ng-init="checked = false">
            <form class=" p-3" action="/easy_question/update/{{$edit['id']}}/{{$edit['course_id']}}" method="post" enctype="multipart/form-data">
                @csrf
