...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('/csss/styleall.css')}}">
    <link rel="stylesheet" href="{{ asset('csss/owl.css')}}">
    <link rel="stylesheet" href="{{ asset('csss/animate.css')}}">
    <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/5.15.3/csss/all.min.css" integrity="sha512-eoq3qjzJlVZ1xJx8Lj0nRUTz1+Dg6WfQ2hO5z5oQb5D5e5x5O7kFz4i4rk7V5P5GDuM1bKdX9LH3qo0TgT6Uw==" crossorigin="anonymous" referrerpolicy="no-referrer" />
